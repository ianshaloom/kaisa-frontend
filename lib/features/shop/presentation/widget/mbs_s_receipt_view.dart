            ...
            children: [
              ConstrainedBox(
                ...
                child: CarouselView(
                  ...
                  children: [
                    for (int i = 0; i < receipt.receiptImgUrl.length; i++)
                      CaroselTile(imgUrl: receipt.receiptImgUrl[i]),
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return CachedNetworkImage(
      ...
      placeholder: (context, url) {
        return Shimmer.fromColors(
          baseColor: colorScheme.primary.withOpacity(0.4),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Text('Device Deatails', style: bodyDft1),
              const Spacer(),
              Text(
                receipt.deviceDatails.toUpperCase(),
                style: bodyDft2.copyWith(
          ...
          Row(
            children: [
              Text('IMEI', style: bodyDft1),
              const Spacer(),
              Text(
                receipt.imei.toString(),
                style: bodyDft2,
              ),
            ],
          ),
