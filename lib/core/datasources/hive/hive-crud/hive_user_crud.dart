...
class HiveUserDataCrud {
  ...
  final Box<UserDataHive> _userDataBox;

  // save user profile data
  Future<void> saveUser(UserDataHive userData) async {
    await _userDataBox.add(userData);
  }

  // get user profile data
  Future<UserDataHive> getUser() async {
    final userData = _userDataBox.values.first;
    return userData;
  }  
